    ...
    <footer class="py-8 px-6 text-left border-t border-slate-200/50 bg-[#262626]">
      <div class="max-w-5xl mx-auto space-y-1 text-[12px] sm:text-[14px] text-[#FFFFFF] font-bold leading-snug">
        ...
        <div class="space-y-2">
          ...
          <div class="flex gap-1 text-[#F39EA3]">
            <span class="shrink-0">•</span>
            <p>由於非投資等級債券之信用評等未達投資等級或未經信用評等，且對利率變動的敏感度甚高，故非投資等級 債券基金可能會因利率上升、市場流動性下降，或債券發行機構違約不支付本金、利息或破產而蒙受虧損。非投資等級債券基金不適合無法承擔相關風險之投資人，投資人投資以非投資等級債券為訴求之基金不宜占其投資組合過高之比重。部份基金或所投資之債券子基金，可能投資美國Rule144A債券，該等債券屬私募性質，較可能發生流動性不足，財務訊息揭露不完整或因價格不透明導致波動性較大之風險，投資人須留意相關風險。</p>
          </div>
          <div class="flex gap-1">
            <span class="shrink-0">•</span>
